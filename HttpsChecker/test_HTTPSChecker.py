...
class TestHTTPSChecker(unittest.TestCase):
    ...
    def test_check_https_to_website_with_HTTPS_enabled(self, mock_sleep, mock_socket, mock_shutdown):
    ...
    @patch("HttpsChecker.HttpsChecker.time.sleep", return_value=None)
    def test_check_https_to_website_without_HTTPS_enabled(self, mock_sleep, mock_socket):
